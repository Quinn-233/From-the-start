...
//	LS9073_send_fun_serial_vgs();
    ...
    while (1) {
        ...
        if (key_flag) {
            key_flag = 0;
			LS9073_send_fun_full_receipt_flexible(0xAAAA, LS9073_CURR_W_BIT_LENGTH_DATA, VGS_test, LS9073_CURR_W_BIT_LENGTH, LS9073_PARAMETER_VGS_EN,LS9073_PARAMETER_A_LOAD_EN,LS9073_PARAMETER_COLOR_M,LS9073_PARAMETER_ID_M);
